...
func RegisterRoutes(r *gin.Engine) {
	...
	r.PATCH("/me", handlers.AuthMiddleware(), handlers.UpdateMeHandler)
	r.POST("/ai/chat", handlers.AuthMiddleware(), handlers.ChatHandler)
	r.GET("/badges/me", handlers.AuthMiddleware(), handlers.GetMyBadgesHandler)
	r.GET("/badges/progress", handlers.AuthMiddleware(), handlers.GetBadgeProgressHandler)
	...
	r.PUT("/communities/:id/rules", handlers.AuthMiddleware(), handlers.UpdateCommunityRulesHandler)
